...
if($_POST["funcion"] == "total_productos_recibidos"){
    $total_productos_recibidos = $dashboard->total_productos_recibidos();
    echo $total_productos_recibidos;
...
if ($_POST["funcion"] == "productos_mas_recibidos") {
    $json = array();
    
    // Obtener los resultados de la función productos_mas_vendidos()
    $resultados = $dashboard->productos_mas_recibidos();
