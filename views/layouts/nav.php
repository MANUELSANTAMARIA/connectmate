...
$menuHome = array(
    ...
    3 => array(
        array(
            'href' => '../views/vendedor_catalogo.php',
            'icon' => 'fas fa-home',
            'title' => 'Home',
            'text' => 'HOME'
        )
    ...
    4 => array(
        array(
            'href' => '../views/impulsador_catalogo.php',
            'icon' => 'fas fa-home',
            'title' => 'Home',
            'text' => 'HOME'
        )
    ...
    5 => array(
        array(
            'href' => '../views/bodega_catalogo.php',
            'icon' => 'fas fa-home',
            'title' => 'Home',
            'text' => 'HOME'
        )
